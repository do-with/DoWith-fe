        ...
        {!isAuthenticated || !user || !user.id ? (
          ...
          <View style={{ alignItems: "center" }}>
            <View style={styles.myProfile}>
              ...
              {user && <Text style={styles.profileText}>{user.name}</Text>}
            </View>
            <View style={styles.myInfoBoardView}>
              <Pressable
                style={styles.myInfoBoard}
              ...
              >
                ...
                <Image
                  source={require("../assets/pride.png")}
                  resizeMode={"contain"}
                  style={styles.img}
                />
            ...
            <Pressable onPress={() => onClickLogoutBtn()} style={styles.logout}>
